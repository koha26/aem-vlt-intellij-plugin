...
<!-- Plugin description -->
AEM FileVault Integration plugin allows developers to interact with Adobe Experience Manager repositories.

Push and pull content to/from AEM using Apache Jackrabbit FileVault.
